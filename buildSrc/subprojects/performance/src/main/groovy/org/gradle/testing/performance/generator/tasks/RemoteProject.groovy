...
class RemoteProject extends CheckoutRemoteProjectTask {
    /**
    ...
    @TaskAction
    void checkoutAndMoveToOutputDir() {
        outputDirectory.deleteDir()
        File checkoutDir = checkout()
        moveToOutputDir(checkoutDir, outputDirectory, subdirectory)
    }
